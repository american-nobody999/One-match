const DivisionApp = (() => {
  ...
  // Description: This module implements a division flashcard application. It provides functionality for displaying division problems, checking answers, tracking scores, and managing a timer. 
  const cards = [
    { q: "12 ÷ 3",  a: "4" },
    { q: "20 ÷ 4",  a: "5" },
    { q: "18 ÷ 2",  a: "9" },
  ...
  // ---- DOM refs ----
  const $ = (id) => document.getElementById(`division-${id}`);
  const el = {
    card: $("card"),
    question: $("question"),
    answer: $("answer"),
  ...
  document.addEventListener("keydown", (e) => {
    if (!document.querySelector('[data-operation="division"]')?.contains(document.activeElement)) return;
